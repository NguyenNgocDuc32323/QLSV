                            ...
                            <div class="details">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group form-box position-relative password-form">
                                        ...
                                        <span class="position-absolute top-50 end-0 translate-middle-y cursor-pointer toggle-password <?php echo isset($errors['password']) ? 'error-password' : ''; ?>"
                                            style="z-index: 10;">
                                    ...
                                    <div class="form-group form-box position-relative password-form">
                                        <input type="password" name="confirm_password" class="form-control"
                                            ...
                                            required autocomplete="new-password">
                                        <span class="position-absolute top-50 end-0 translate-middle-y cursor-pointer toggle-password <?php echo isset($errors['confirm_password']) ? 'error-password' : ''; ?>"
                                            style="z-index: 10;">
                                            <i class="see-password fa fa-eye"></i>
                                        </span>
